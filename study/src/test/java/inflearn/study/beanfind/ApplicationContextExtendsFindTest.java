...
public class ApplicationContextExtendsFindTest {
    ...
    @Test
    @DisplayName("부모 타입으로 측정, 자식이 둘 이상 있으면, 중복 오류가 발생한다")
    ...
    @Test
    @DisplayName("부모 타입으로 측정, 자식이 둘 이상 있으면, 빈 이름을 지정하면 된다.")
